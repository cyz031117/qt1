    ...
    ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle("Guide ");//设置主窗口标题
    this->setWindowIcon(QIcon("Guide.ico"));//设置图标
    ui->label1->setText("[当前有      条Guide]");
...
{
    QMessageBox::Button btn = QMessageBox::question(this, "退出Guide", "是否退出Guide？");
...
{
    ui->newmemo->setText("新建Guide");
    ui->viewmemo->setText("查看Guide");
    ui->backpackbt->setText("其它");
}
...
{
    QMessageBox::Button btn=QMessageBox::information(this,"其他","敬请期待");
}
